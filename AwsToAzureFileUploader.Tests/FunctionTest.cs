...
namespace AwsToAzureFileUploader.Tests
{
    public class FunctionTest
    {
        ...
        public async Task TestS3EventLambdaFunction()
        {
            ...
            Environment.SetEnvironmentVariable("AzureAccessKey", "Enter Your Azure Access Key Here");
            Environment.SetEnvironmentVariable("StorageAccount", "Enter Your Azure Storage Account Here");
            Environment.SetEnvironmentVariable("OutputContainer", "Enter Your Azure Container Here");

            var bucketName = "lambda-AwsToAzureFileUploader-".ToLower() + DateTime.Now.Ticks;
            var key = "text.txt";
